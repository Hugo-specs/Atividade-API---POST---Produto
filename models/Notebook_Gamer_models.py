...
class NotebookGamer(db.Model):                   # Define a classe Carro como um modelo do SQLAlchemy (herda de db.Model)
    __tablename__ = 'Notebook Gamer'              # Nome da tabela no banco de dados será "carros"
